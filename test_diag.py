...
## input parameters for decorrelation calculations
  ...
  l1 = math.sin(math.radians(1.414));                # l-coordinate of the source;
  m1 = math.sin(math.radians(1.414));                # m-coordinate of the source;
  l2 = math.sin(math.radians(1.414));                # l-coordinate of the source;
  m2 = math.sin(math.radians(-1.414));                # m-coordinate of the source;

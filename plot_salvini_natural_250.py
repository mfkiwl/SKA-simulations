...
#     plt.plot(x, decor2[i,:])
    ...
    plt.title('Natural Wt Theoretical Analysis vs SKA Simulator with Salvini BDA'+ str(maxbmult))
    ...
    plot_file = 'salvini_natural_weighting_BDA' + str(maxbmult)
    plot_file = 'Figure_9b_plot'
#   plt.legend(loc=1)

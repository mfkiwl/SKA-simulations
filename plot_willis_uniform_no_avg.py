 ...
 # weights approximuated based on radial density of (u, v)-points
  ...
  if single_proc:
    weight_uni = BDA_utility_functions.calculate_basic_uniform_BDA_weight_single(Lx,Ly,Lz,dec,GMST,wavelength, threshhold)
     ...
     weight_uni, weightuni1 = BDA_utility_functions.calculate_basic_uniform_BDA_weight(Lx,Ly,Lz,dec,GMST,wavelength,threshhold,w_factor_weight)
...
# plt.legend(loc=1)
  ...
  plot_file = 'sjw_uniform_weighting_014sec_plot_avg_8'
  plot_file = 'Figure_3a_plot'
